...
//         check('adharNumber', 'Please enter a valid 10-digit mobile number').matches(/^\d{12}$/),
...
//             // // Create a new user
//             user = new User({ rollNumber,fatherName,studentName,motherName,dob,mobileNumber,adharNumber,branch ,year,gender,category ,email});
